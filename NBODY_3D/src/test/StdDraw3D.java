...
KeyListener, ActionListener, ChangeListener, ComponentListener, WindowFocusListener
{
    ...
    private static void initialize () {
       ...
       // frame.setResizable(fullscreen);
        ...
        //Adds button to add a new planet
        ...
        button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String str = JOptionPane.showInputDialog("entering x;y;xv;yv;m;r;ang");
				if (!"".equals(str)) {
					...
					Planet pNew = new Planet(arr[0],arr[1],arr[2],arr[3],arr[4],arr[5],arr[6],"sun.jpg");
