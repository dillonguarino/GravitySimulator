...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static JTextField  testField;
    // for synchronization
    ...
    private static void init() {
        ...
        JButton button = new JButton("dfsfsdfdsfddd");
        panel.add(button);
        button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String str = JOptionPane.showInputDialog("Input numbers,seperated by space");
				if (!"".equals(str)) {
					...
					Planet pNew =NBody.getPlanet(arr[0],arr[1],arr[2],arr[3],arr[4]);
					//System.out.println(pNew.x);
					NBody.numPlanets++;
					Planet[] newArray = new Planet[NBody.numPlanets];
					 
		
			        for(int i=0;i < NBody.numPlanets-1;i++)
			            newArray[i] = NBody.planets[i];
			        newArray[NBody.numPlanets-1] = pNew;
			        NBody.planets = newArray;
				}
			}
		});
